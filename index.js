...
/******** OWNER NUMBER**********/
const ownerNumber = ["6285263628789@s.whatsapp.net","6285263628789@s.whatsapp.net"] 
/************************************/
...
• Limit: ${limitawal-updated.limit}`
            ...
            break
				...
				case 'slap':
                    ...
                    if (isLimit(sender)) return reply(ind.limitend(pusname))
					const slap =['anjing','babi lu','anak anjing','udah tolol nub Lagi','muka lo kek monyet','udah jomblo sendirian lagi dirumah tolol','so so an mau punya pacar muka aja kek monyet lepass dari kandang','ganteng doang di toxic aja dibilang baperan','bangsat kau','lihat anak anjing lagi baca','ganteng doang jemput cewe depan gang','kamu cantik beb bullshit anjing cowo buaya','anak dajjal','puki lu','anjing ngajak gelud','sama hantu takut cupu','cupu cupu aja gausah bacot','bocah lu semua','3 Hari Lagi']
           ...
           if (isLimit(sender)) return reply(ind.limitend(pusname))
				...
				if (!isQuotedSticker) return reply('𝗥𝗲𝗽𝗹𝘆/𝘁𝗮𝗴 𝘀𝘁𝗶𝗰𝗸𝗲𝗿 !')
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						if (err) return reply(ind.stikga())
						buffer = fs.readFileSync(ran)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: '𝗷𝗮𝗱𝗶 '})
						fs.unlinkSync(ran)
					})
					await limitAdd(sender)
				break 
				...
				case 'add':
					...
					if (args.length < 1) return reply('Yang mau di add siapa bodo?')
